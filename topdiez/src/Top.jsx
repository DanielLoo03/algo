...
function Top() {
  return (
    <div className="relative h-screen bg-white text-black overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-full h-1/3 bg-gradient-to-t from-blue-100 to-white z-0 pointer-events-none" />

      {/* Barra de navegación fija */}
      <nav className="w-full bg-white text-black py-4 px-8 fixed top-0 left-0 shadow-md z-10 flex justify-between items-center">
        <h2 className="text-2xl font-semibold">Mi Blog</h2>
        <ul className="flex space-x-6 text-lg">
          <li><Link to="/inicio" className="hover:underline">Top 10</Link></li>
